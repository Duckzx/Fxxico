...
const francisco = {
  username:   "Duckzx",
  location:   "Brasil 🇧🇷",
  role:       ["Software Engineering Student", "Legal Assistant"],
  languages:  ["Português", "English"],
  interests:  ["Web Dev", "Mobile", "Generative Art", "Music 🎵"],
  currentFocus: "Building a killer portfolio — one project at a time.",
};
```
...
[![GitHub Streak](https://streak-stats.demolab.com/?user=Duckzx&theme=radical&hide_border=true&background=0d1117&stroke=FF6B6B&ring=FF6B6B&fire=FF6B6B&currStreakLabel=FF6B6B)](https://git.io/streak-stats)
